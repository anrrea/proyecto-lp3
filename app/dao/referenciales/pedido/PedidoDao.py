...
class PedidoDao:
    ...
    def getPedidos(self):
        ...
        try:
            ...
            app.logger.error(f"Error al obtener todas las pedidos: {str(e)}")
            return []
    ...
    def getPedidoById(self, id):
        ...
        try:
            ...
            pedidoEncontrada = cur.fetchone() # Obtener una sola fila
            if pedidoEncontrada:
                return {
                        "id": pedidoEncontrada[0],
                        "descripcion": pedidoEncontrada[1]
                    }  # Retornar los datos de el pedido
            else:
    ...
    def deletePedido(self, id):
        ...
        try:
            cur.execute(updatePedidoSQL, (id,))
